...
<div   className='cont'>
   ...
   <img   src='./images/circle.png'  width="600" height="200"    ></img>
</div><br></br>
...
<div className="row">
  ...
  <h3><button className='btn'  onClick={handelClicka} style={{ backgroundColor: buttonColora === 'primary' ? 'black' : 'green' }}>3</button></h3>
  </div>
  <div className="column"  >
  <img   src='./images/triangle2.png'  width="600" height="200"    ></img>
  <h3><button className='btn'  onClick={handelClick2a} style={{ backgroundColor: buttonColor2a === 'primary' ? 'black' : 'red' }}>2</button></h3>
  </div>
  <div className="column"  >
  <img   src='./images/circle2.png'  width="600" height="200"    ></img>
