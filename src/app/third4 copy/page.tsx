...
//   };
    ...
    const handleRestart = () => {
      ...
      const [correctAnswer4, setCorrectAnswer4] = useState(20); 
      ...
      const handleSubmit4 = (event: { preventDefault: () => void; }) => {
        ...
        if (userInputValue4 === correctAnswer4) {
          setIsCorrect4(true);
      ...
      useEffect(() => {
        const storedUserInput4 = localStorage.getItem('userInput4');
        const storedCorrectAnswer4 = localStorage.getItem('correctAnswer4');
        const storedIsCorrect4 = localStorage.getItem('isCorrect4');
    
        if (storedUserInput4) {
          setUserInput4(storedUserInput4);
        }
        if (storedCorrectAnswer4) {
          setCorrectAnswer4(parseInt(storedCorrectAnswer4));
        }
        if (storedIsCorrect4) {
          setIsCorrect4(storedIsCorrect4 === 'true');
        }
      }, []);
...
<h3><a  href='./third5'><button className='btn1' >  التالي </button> </a></h3>
<h3><a  href='./third3'><button className='btn2' >السابق</button></a></h3>
